...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1778781366);
user_pref("app.update.lastUpdateTime.background-update-timer", 1778781366);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1778820397);
user_pref("app.update.lastUpdateTime.region-update-timer", 1778781366);
user_pref("app.update.lastUpdateTime.rs-experiment-loader-timer", 1778781339);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1778781366);
user_pref("app.update.lastUpdateTime.telemetry_untrustedmodules_ping", 1778784967);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1778781366);
user_pref("app.update.migrated.updateDir3.4DCB4AEE11B56A92", true);
user_pref("app.update.mode", 0);
user_pref("app.update.service.enabled", false);
user_pref("apz.content_response_timeout", 60000);
user_pref("browser.bookmarks.restore_default_bookmarks", false);
user_pref("browser.contentblocking.category", "custom");
user_pref("browser.contextual-services.contextId", "15272d76-08bf-4f15-862a-a2dfe389c137");
user_pref("browser.contextual-services.contextId.timestamp-in-seconds", 1778781338);
...
user_pref("browser.newtabpage.activity-stream.impressionId", "{70d94888-52ab-4059-82a1-f13dbdbd5372}");
...
user_pref("browser.startup.lastColdStartupCheck", 1778781340);
...
user_pref("captchadetection.lastSubmission", 1778781);
user_pref("captivedetect.canonicalURL", "");
user_pref("datareporting.dau.cachedUsageProfileGroupID", "440899ad-3725-4a2a-91b3-c5907b1223d2");
user_pref("datareporting.dau.cachedUsageProfileID", "e62e25e5-1de1-4247-a080-ca0eb4bdc7f1");
...
user_pref("extensions.webextensions.uuids", "{\"data-leak-blocker@mozilla.com\":\"adaaa24d-e9fd-4b04-b6e5-b577d7cee752\",\"formautofill@mozilla.org\":\"4843347a-e4de-4550-9267-dbea0cce73e8\",\"ipp-activator@mozilla.com\":\"a0316005-2776-43d6-99ce-d3a9caa3e410\",\"pictureinpicture@mozilla.org\":\"8d65243a-3336-41f9-afc0-c772b5bb3ddd\",\"addons-search-detection@mozilla.com\":\"8fbc027f-0ddc-420a-a4a9-f03b2f5e4a51\",\"webcompat@mozilla.org\":\"9a310967-e580-48bf-b3e8-4eafebbc122d\",\"newtab@mozilla.org\":\"c71f089c-48e5-40fb-a349-5853f7f46117\",\"default-theme@mozilla.org\":\"b4ef4bf7-ffbb-41cf-92e0-15afe91326a0\"}");
...
user_pref("gfx-shader-check.driver-version", "31.0.21924.61");
...
user_pref("idle.lastDailyNotification", 1778787036);
...
user_pref("media.gmp-manager.lastCheck", 1778781829);
user_pref("media.gmp-manager.lastEmptyCheck", 1778781829);
...
user_pref("nimbus.profileId", "c62add7c-104b-4698-b2b4-c1b9dde4cd73");
user_pref("pdfjs.disabled", true);
user_pref("pdfjs.enabledCache.state", false);
user_pref("permissions.isolateBy.userContext", true);
user_pref("places.database.lastMaintenance", 1778787039);
user_pref("plugin.state.flash", 0);
user_pref("privacy.bounceTrackingProtection.hasMigratedUserActivationData", true);
user_pref("privacy.purge_trackers.date_in_cookie_database", "0");
user_pref("privacy.purge_trackers.last_purge", "1778787037476");
...
user_pref("storage.vacuum.last.places.sqlite", 1778787037);
user_pref("toolkit.cosmeticAnimations.enabled", false);
user_pref("toolkit.profiles.storeID", "400ea8a2");
user_pref("toolkit.shutdown.fastShutdownStage", 3);
user_pref("toolkit.startup.last_success", 1778781334);
