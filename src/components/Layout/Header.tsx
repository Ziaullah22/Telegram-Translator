          ...
          <div className="flex items-center space-x-4 xl:space-x-10">
            ...
            <nav className="hidden xl:flex items-center gap-1">
              ...
              <div className="relative group ml-1">
                <button id="nav-leads-group" className={`flex items-center gap-1.5 py-2 px-3 rounded-lg text-[10px] font-black uppercase tracking-widest transition-all ${['/crm', '/instagram-leads'].includes(location.pathname) ? 'text-blue-600 dark:text-blue-500 bg-blue-50/50 dark:bg-white/5' : 'text-gray-400 hover:text-gray-600 dark:hover:text-gray-200 hover:bg-gray-50 dark:hover:bg-white/5'}`}>
